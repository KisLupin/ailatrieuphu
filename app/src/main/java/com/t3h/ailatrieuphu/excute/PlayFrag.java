...
public class PlayFrag extends Fragment implements View.OnClickListener, Runnable {
    ...
    private void inits(int temp){
        ...
        setAnim(ans1,R.anim.left_to_right);
        setAnim(ans2,R.anim.right_to_left);
        setAnim(ans3,R.anim.left_to_right);
        setAnim(ans4,R.anim.right_to_left);
    }
...
//            timeCount --;
    ...
    private void setAnim(Button bt,int anID){
        Animation animation = AnimationUtils.loadAnimation(getContext(),anID);
